...
function Modal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-backdrop", onMouseDown: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal", onMouseDown: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-title", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: onClose, children: "关闭" })
    ] }),
    children
  ] }) });
}
...
async function getIntegrations(masterPassword) {
  return invoke("integrations_get", { masterPassword });
}
async function testCloudflare(email, apiKey) {
  return invoke("cloudflare_test", { email, apiKey });
}
async function saveCloudflare(masterPassword, email, apiKey) {
  return invoke("cloudflare_save", { masterPassword, email, apiKey });
}
async function clearCloudflare(masterPassword) {
  return invoke("cloudflare_clear", { masterPassword });
}
async function testDnspod(tokenId, token) {
  return invoke("dnspod_test", { tokenId, token });
}
async function saveDnspod(masterPassword, tokenId, token) {
  return invoke("dnspod_save", { masterPassword, tokenId, token });
}
async function clearDnspod(masterPassword) {
  return invoke("dnspod_clear", { masterPassword });
}
async function listDomains(masterPassword, providerFilter, search) {
  return invoke("domains_list", {
    masterPassword,
    providerFilter: providerFilter ?? void 0,
    search: search || void 0
  });
}
async function listRecords(masterPassword, provider, domainId, domainName) {
...
async function createRecord(masterPassword, provider, domainId, domainName, req) {
...
async function updateRecord(masterPassword, provider, domainId, domainName, req) {
...
async function deleteRecord(masterPassword, provider, domainId, recordId) {
...
function AppProvider({ children }) {
  const [masterPassword, setMasterPassword] = reactExports.useState(null);
  const [vaultStatus, setVaultStatus] = reactExports.useState(null);
  const [notices, setNotices] = reactExports.useState([]);
  const refreshVaultStatus = reactExports.useCallback(async () => {
  ...
  const notifySuccess = reactExports.useCallback(
    (message) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-title", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "muted", children: "单条记录新增 / 编辑 / 删除，新增支持冲突策略" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: () => void load(), disabled: busy, children: "刷新" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-primary", onClick: () => setCreating(true), disabled: busy, children: "新增记录" })
      ] })
    ] }),
    error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", children: error }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "table", style: { marginTop: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: "10%" }, children: "类型" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: "18%" }, children: "主机记录" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: "44%" }, children: "记录值" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: "10%" }, children: "TTL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { width: "18%" }, children: "操作" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        rows.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: r.record_type }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: r.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { wordBreak: "break-all" }, children: r.content }),
...
function RecordModal({
  ...
  const [recordType, setRecordType] = reactExports.useState(initial?.record_type ?? "A");
  const [name, setName] = reactExports.useState(initial?.name ?? "@");
  const [content, setContent] = reactExports.useState(initial?.content ?? "");
  const [ttl, setTtl] = reactExports.useState(initial?.ttl ?? 600);
  const [mxPriority, setMxPriority] = reactExports.useState(initial?.mx_priority ?? 10);
  const [srvPriority, setSrvPriority] = reactExports.useState(initial?.srv_priority ?? 0);
  const [srvWeight, setSrvWeight] = reactExports.useState(initial?.srv_weight ?? 0);
  const [srvPort, setSrvPort] = reactExports.useState(initial?.srv_port ?? 0);
  const [caaFlags, setCaaFlags] = reactExports.useState(initial?.caa_flags ?? 0);
  const [caaTag, setCaaTag] = reactExports.useState(initial?.caa_tag ?? "issue");
  const [conflictStrategy, setConflictStrategy] = reactExports.useState("do_not_create");
  const [busy, setBusy] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { title, onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "类型",
        /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: "select", value: recordType, onChange: (e) => setRecordType(e.target.value), children: RECORD_TYPES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t, children: t }, t)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "TTL（秒）",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: ttl, onChange: (e) => setTtl(Number(e.target.value || 0)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
      "主机记录（Name）",
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: name, onChange: (e) => setName(e.target.value), placeholder: "例如 @ 或 www 或 _acme-challenge" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
      "记录值（Content）",
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: content, onChange: (e) => setContent(e.target.value) })
    ] }),
    recordType === "MX" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
      "MX 优先级",
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: mxPriority, onChange: (e) => setMxPriority(Number(e.target.value || 0)) })
    ] }) : null,
    recordType === "SRV" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "SRV 优先级",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: srvPriority, onChange: (e) => setSrvPriority(Number(e.target.value || 0)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "SRV 权重",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: srvWeight, onChange: (e) => setSrvWeight(Number(e.target.value || 0)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "SRV 端口",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: srvPort, onChange: (e) => setSrvPort(Number(e.target.value || 0)) })
      ] })
    ] }) : null,
    recordType === "CAA" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "CAA Flags",
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "input", value: caaFlags, onChange: (e) => setCaaFlags(Number(e.target.value || 0)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
        "CAA Tag",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "select", value: caaTag, onChange: (e) => setCaaTag(e.target.value), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "issue", children: "issue" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "issuewild", children: "issuewild" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "iodef", children: "iodef" })
        ] })
      ] })
    ] }) : null,
    isCreate ? /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "label", children: [
      "冲突策略（同名 + 同类型）",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "select", value: conflictStrategy, onChange: (e) => setConflictStrategy(e.target.value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "do_not_create", children: "不创建" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "overwrite", children: "强制覆盖" })
      ] })
    ] }) : null,
    error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", children: error }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", style: { justifyContent: "flex-end" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-secondary", onClick: onClose, disabled: busy, children: "取消" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-primary", onClick: () => void submit(), disabled: busy, children: "保存" })
    ] })
  ] }) });
}

const RecordsPage$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  RecordModal,
  RecordsPage
